...
class Multi_resource_alignment_mod(Placement):
    # Mem_Abv_Ratio = 0

    def __init__(self):
        super(Multi_resource_alignment_mod, self).__init__()
        self.requestLatency = []
        return
    ...
    def VMplacement(self):
        ...
        while unplaced_tasks:
            ...
            if not enough_resource:
                print "Multi-Resource Packing MOD: not enough resource for all tasks, time", current_time
    ...
    def getResults(self, current_round):
        super(Multi_resource_alignment_mod, self).getResults(current_round)

    def __str__(self):
        return "Multi Resource Alignment MOD"
